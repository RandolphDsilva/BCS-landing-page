...
-- ============================================================
-- 3) Optional: attach the souvenir PDF to every row.
-- After uploading sabha-2026.pdf to a public bucket 'souvenir',
-- run the UPDATE below to enable the "View in Souvenir" button:
--
